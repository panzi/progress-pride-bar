...
fn print_line3or4(mut out: impl Write, fchars: f64, tri: &str, bar_color: Rgb, background_color: Rgb) -> std::io::Result<()> {
    ...
    if fchars > 15.5 {
        ...
        write!(out, "\x1B[38;2;{wh_r};{wh_g};{wh_b}m\x1B[48;2;{tp_r};{tp_g};{tp_b}m█{tri}\x1B[38;2;{tp_r};{tp_g};{tp_b}m\x1B[48;2;{tb_r};{tb_g};{tb_b}m{tri}\x1B[38;2;{tb_r};{tb_g};{tb_b}m\x1B[48;2;{br_r};{br_g};{br_b}m{tri}\x1B[48;2;{bk_r};{bk_g};{bk_b}m\x1B[38;2;{br_r};{br_g};{br_b}m{tri}\x1B[38;2;{bk_r};{bk_g};{bk_b}m\x1B[48;2;{r};{g};{b}m{tri}\x1B[0m\x1B[K\n")?;
    } else if fchars > 8.5 {
        // white + pink + blue + brown + black
        let Rgb([r, g, b]) = blend(background_color, BLACK, (fchars - 8.5) * 0.5);
        write!(out, "\x1B[38;2;{wh_r};{wh_g};{wh_b}m\x1B[48;2;{tp_r};{tp_g};{tp_b}m█{tri}\x1B[38;2;{tp_r};{tp_g};{tp_b}m\x1B[48;2;{tb_r};{tb_g};{tb_b}m{tri}\x1B[38;2;{tb_r};{tb_g};{tb_b}m\x1B[48;2;{br_r};{br_g};{br_b}m{tri}\x1B[48;2;{r};{g};{b}m\x1B[38;2;{br_r};{br_g};{br_b}m{tri}\x1B[38;2;{r};{g};{b}m\x1B[49m{tri}\x1B[0m\x1B[K\n")?;
    } else if fchars > 6.5 {
        // white + pink + blue + brown
        let Rgb([r, g, b]) = blend(background_color, BROWN, (fchars - 6.5) * 0.5);
        write!(out, "\x1B[38;2;{wh_r};{wh_g};{wh_b}m\x1B[48;2;{tp_r};{tp_g};{tp_b}m█{tri}\x1B[38;2;{tp_r};{tp_g};{tp_b}m\x1B[48;2;{tb_r};{tb_g};{tb_b}m{tri}\x1B[38;2;{tb_r};{tb_g};{tb_b}m\x1B[48;2;{r};{g};{b}m{tri}\x1B[49m\x1B[38;2;{r};{g};{b}m{tri}\x1B[0m\x1B[K\n")?;
    } else if fchars > 4.5 {
        // white + pink + blue
        let Rgb([r, g, b]) = blend(background_color, TRANS_BLUE, (fchars - 4.5) * 0.5);
        write!(out, "\x1B[38;2;{wh_r};{wh_g};{wh_b}m\x1B[48;2;{tp_r};{tp_g};{tp_b}m█{tri}\x1B[38;2;{tp_r};{tp_g};{tp_b}m\x1B[48;2;{r};{g};{b}m{tri}\x1B[38;2;{r};{g};{b}m\x1B[49m{tri}\x1B[0m\x1B[K\n")?;
    } else if fchars > 2.5 {
        // white + pink
        let Rgb([r, g, b]) = blend(background_color, TRANS_PINK, (fchars - 2.5) * 0.5);
        write!(out, "\x1B[38;2;{wh_r};{wh_g};{wh_b}m\x1B[48;2;{r};{g};{b}m█{tri}\x1B[38;2;{r};{g};{b}m\x1B[49m{tri}\x1B[0m\x1B[K\n")?;
    } else {
        // white
        let Rgb([r, g, b]) = blend(background_color, WHITE, fchars / 2.5);
        write!(out, "\x1B[0m\x1B[38;2;{r};{g};{b}m█{tri}\x1B[0m\x1B[K\n")?;
    }
